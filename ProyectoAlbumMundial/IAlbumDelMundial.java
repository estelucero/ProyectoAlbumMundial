...
public interface IAlbumDelMundial {
	 ...
	 * Si el participante no está registrado, se debe lanzar una excepción.
	 */
	int buscarFiguritaRepetida(int dni); // este
	 ...
	 * Si el participante no está registrado, se debe lanzar una excepción.
	 */
	String darNombre(int dni); // gonza
	 ...
	 */
	String darPremio(int dni); // gonza
	 ...
	 *     " - ($dni) $nombre: $premio"
	 */
	String listadoDeGanadores(); //gonza
	 ...
	 */
	 List<String> participantesQueCompletaronElPais(String nombrePais); // este
