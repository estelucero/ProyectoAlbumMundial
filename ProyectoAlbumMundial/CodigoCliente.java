...
public class CodigoCliente {
	...
	public static void main(String[] args) {
		...
		sistema.registrarParticipante(999999, "Gonzalo", "Tradicional");
		...
		for (int i =0;i<500;i++) {
			...
			sistema.pegarFiguritas(777777);
			sistema.comprarFiguritas(999999);
			sistema.pegarFiguritas(999999);
		}
		...
		for (String item: sistema.participantesQueCompletaronElPais("Inglaterra"))
